const pt = {
  ...
  messages: {
    ...
    errorAssignTask: "Erro ao atribuir tarefa",
    projectAnalysis: "Análise do Projeto",
    analyzeProjectHealth: "Analisar Saúde do Projeto", 
    analysisDescription: "Nosso sistema irá analisar o andamento do projeto e sugerir melhorias automáticas.",
    startAnalysis: "Iniciar Análise",
    analyzing: "Analisando...",
    projectCompleted: "Projeto Concluído!",
    allTasksCompleted: "Todas as tarefas foram finalizadas com sucesso.",
    daysAhead: "Dias de Antecedência",
    completed: "Concluído",
    probabilityOfDelay: "Probabilidade de Atraso",
    delayedTasks: "Tarefas Atrasadas",
    ...
    applying: "Aplicando...",
    noSuggestions: "Ótimo! O projeto está saudável e não requer ajustes no momento.",
    reanalyzeProject: "Reanalisar Projeto",
  ...
  toast: {
    ...
    analysisFailed: "Não foi possível analisar o projeto",
    suggestionApplied: "Sugestão aplicada!",
    suggestionError: "Erro ao aplicar sugestão", 
    suggestionFailed: "Não foi possível aplicar a sugestão",  
  },
  dadosUsuario: {
    title: "Meus Dados",
    name: "Nome",
