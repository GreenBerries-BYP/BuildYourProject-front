const en = {
  ...
  messages: {
    ...
    none: "N/A",
    errorNewSubtask: "Error creating subtask", 
    optional: "optional",   
    none: "None",
    selectCollaborator: "Select a collaborator",
    selectOption: "Select an option",
    errorAssignTask: "Error assigning task",
    projectAnalysis: "Project Analysis",
    analyzeProjectHealth: "Analyze Project Health",
    analysisDescription: "Our system will analyze the project progress and suggest automatic improvements.",
    startAnalysis: "Start Analysis",
    analyzing: "Analyzing...",
    projectCompleted: "Project Completed!",
    allTasksCompleted: "All tasks have been successfully completed.",
    daysAhead: "Days Ahead",
    completed: "Completed",
    probabilityOfDelay: "Probability of Delay",
    delayedTasks: "Delayed Tasks",
    remainingDays: "Remaining Days",
    pendingTasks: "Pending Tasks",
    daysDelayed: "Days Delayed",
    recommendedSuggestions: "Recommended Suggestions",
    applySuggestion: "Apply Suggestion",
    applying: "Applying...",
    noSuggestions: "Great! The project is healthy and doesn't require adjustments at the moment.",
    reanalyzeProject: "Reanalyze Project",
  ...
  toast: {
    ...
    analysisFailed: "Could not analyze the project",
    suggestionApplied: "Suggestion applied!",
    suggestionError: "Error applying suggestion",
    suggestionFailed: "Could not apply the suggestion",
  },
  dadosUsuario: {
    title: "My Data",
    name: "Full Name",
  ...
  calendar: {
    ...
    helloUser: "Hello",
    connectDescription: "Connect your Google Calendar to view your events.",
    connectButton: "Connect Google Calendar",
    connecting: "Connecting...",
    connectionNotice: "You are already logged into the system. This connection is only to access your Google Calendar events.",
    
    // Events section
    eventsTitle: "Your Google Calendar Events",
    ...
    noEventsMessage: "Your calendar is empty for the next 30 days.",
    noEventsHint: 'Click "New Event" to add an event to your calendar.',
    upcomingEvents: "Upcoming Events",
    updatedOn: "Updated on:",
    
    // Event details
    eventNoTitle: "Untitled event",
    eventDate: "Date:",
    eventLocation: "Location:",
    
    // Status messages
    calendarConnected: "Calendar connected successfully!",
    calendarDisconnected: "Calendar disconnected!",
    eventCreated: "Event created in Google Calendar!",
    
    // Errors
    googleConfigError: "Google client ID not configured.",
    connectionError: "Unable to connect to Google Calendar.",
    loadEventsError: "Unable to load events.",
    tokenError: "Unable to connect with Google Calendar.",
  }
};
